...
SELECT app_name, reviews, price FROM analytics WHERE price BETWEEN .10 and 1.00 LIMIT 10;
...
SELECT app_name, reviews, min_installs, min_installs/reviews AS ratio_install_to_reviews 
    FROM analytics 
    WHERE min_installs >= 100000
     ORDER BY ratio_install_to_reviews desc
     LIMIT 1; 